...
export default { loadAmapScript, createAmapMap, destroyAmapMap, setAmapView, addAmapMarker, addAmapLabelMarker, bindAmapPopup, addAmapCluster, clearAmapExtraMarkers, addAmapRoute, onAmapClickForPick }
