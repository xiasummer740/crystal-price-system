  ...
  <div class="page-container">
    ...
    <div class="page-content" v-if="detail">
      ...
      <van-cell-group inset title="其他信息">
        ...
        <van-cell title="规格书"><template #value><a v-if="detail.spec_document" :href="detail.spec_document" target="_blank" class="spec-link">{{ detail.spec_document }}</a><span v-else>-</span></template></van-cell>
